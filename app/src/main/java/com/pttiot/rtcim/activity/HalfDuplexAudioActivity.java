...
public class HalfDuplexAudioActivity extends AppCompatActivity {
    ...
    public static final String AUDIO_MEDIA_ID = "ARDAMSa";
    ...
    protected void onCreate ( @Nullable Bundle savedInstanceState ) {
        ...
        signalClient = SignalClient.getInstance();
        initView();
        initVideoWork();
...
//        MediaStream locationStream = mPeerConnectionFactory.createLocalMediaStream("AUDIO_MEDIA_ID");
//        locationStream.addTrack()


        adm.release();

        String roomName = getIntent().getStringExtra("RoomName");
        signalClient.joinRoom(getString(R.string.default_server),roomName);
    }
