package com.pttiot.rtcim.fragments;
...
import com.pttiot.rtcim.activity.GroupChatRoomActivity;
import com.pttiot.rtcim.util.AppUtil;

/**
 *
 * Created by guojianyong  on 2019/5/13.
 *
 */
public class ChatRoomFragment extends Fragment {
    ...
    private GroupChatRoomActivity activity;
    ...
    public void onAttach(Context context) {
        ...
        activity = (GroupChatRoomActivity) getActivity();
    }
    @Override
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        if (rootView == null) {
            rootView = inflater.inflate(R.layout.frame_chatroom_controller, container, false) ;
            initView(rootView);
            initListener();
        }
        return rootView;
    ...
    private void toggleMic(boolean isMicEnable) {
        if (isMicEnable) {
            ...
            if (drawable != null) {
                drawable.setBounds(0, 0, AppUtil.dip2px(activity, 60), AppUtil.dip2px(activity, 60));
            }
