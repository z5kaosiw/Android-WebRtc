...
class WebRtcAudioTrack {
  ...
  //add by guojianyong
  private  static  int  USE_AUDIO_STREAM = AudioManager.STREAM_MUSIC;
...
//    return audioManager.getStreamMaxVolume(AudioManager.STREAM_VOICE_CALL);
    return audioManager.getStreamMaxVolume(USE_AUDIO_STREAM);
  }
...
//    audioManager.setStreamVolume(AudioManager.STREAM_VOICE_CALL, volume, 0);
    audioManager.setStreamVolume(USE_AUDIO_STREAM, volume, 0);
    return true;
  }
...
//    return audioManager.getStreamVolume(AudioManager.STREAM_VOICE_CALL);
    return audioManager.getStreamVolume(USE_AUDIO_STREAM);
  }
...
//    final int nativeOutputSampleRate =  AudioTrack.getNativeOutputSampleRate(AudioManager.STREAM_VOICE_CALL);
    final int nativeOutputSampleRate =  AudioTrack.getNativeOutputSampleRate(USE_AUDIO_STREAM);
  ...
  private static AudioTrack createAudioTrackOnLowerThanLollipop(
      int sampleRateInHz, int channelConfig, int bufferSizeInBytes) {
//    return new AudioTrack(AudioManager.STREAM_VOICE_CALL, sampleRateInHz, channelConfig, AudioFormat.ENCODING_PCM_16BIT, bufferSizeInBytes, AudioTrack.MODE_STREAM);
    return new AudioTrack(USE_AUDIO_STREAM, sampleRateInHz, channelConfig, AudioFormat.ENCODING_PCM_16BIT, bufferSizeInBytes, AudioTrack.MODE_STREAM);
  }
